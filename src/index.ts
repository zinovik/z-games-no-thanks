...
export class NoThanks extends BaseGame {
  ...
  public getRules = (): string[] => {
    ...
    rules.push('No Thanks! is a card game for three to five players designed by Thorsten Gimmler. Originally called Geschenkt! (presented '
      + '(as a gift) in German) and published by Amigo Spiele in 2004, it was translated into English by Z-Man Games.');

    rules.push('There are playing cards numbered 3 to 35 in the game, and nine cards are removed from the deck. Each player receives 11 chips. '
    ...
    rules.push('At the end of the game, cards give points according to their value, but cards in a row only count as a single card with the lowest '
